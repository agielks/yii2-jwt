 ...
 *
 * You may use JwtBearerAuth by attaching it as a behavior to a controller or module, like the following:
 *
 * ```php
 ...
 *     return [
 *         'bearerAuth' => [
 *             'class' => \agielks\yii2\jwt\JwtBearerAuth::className(),
 *         ],
 *     ];
 * }
 * ```
